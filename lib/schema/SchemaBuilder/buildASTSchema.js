...
function mergeObjectTypeDefinitions(acc, objectTypeDefinition) {
  return (0, _assign2.default)(acc, {
    interfaces: [].concat((0, _toConsumableArray3.default)(acc.interfaces), (0, _toConsumableArray3.default)(objectTypeDefinition.interfaces)),
    directives: [].concat((0, _toConsumableArray3.default)(acc.directives), (0, _toConsumableArray3.default)(objectTypeDefinition.directives)),
    fields: [].concat((0, _toConsumableArray3.default)(acc.fields), (0, _toConsumableArray3.default)(objectTypeDefinition.fields))
...
ast) {
  ...
  (0, _keys2.default)(nodeMapWithAllReferences).forEach(function (name) {
    if (nodeMapWithAllReferences[name].length > 1) {
      if (name === 'Query') {
        nodeMapWithAllReferences.Query = nodeMapWithAllReferences.Query.reduce(mergeObjectTypeDefinitions);
      } else if (name === 'Mutation') {
        nodeMapWithAllReferences.Mutation = nodeMapWithAllReferences.Mutation.reduce(mergeObjectTypeDefinitions);
      } else {
