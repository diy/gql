  ...
  (0, _keys2.default)(nodeMapWithAllReferences).forEach(function (name) {
    if (nodeMapWithAllReferences[name].length > 1) {
      if (name === 'Query') {
        ...
        nodeMapWithAllReferences.Query = nodeMapWithAllReferences.Query.reduce(function (acc, query) {
          return (0, _assign2.default)(acc, {
            interfaces: [].concat((0, _toConsumableArray3.default)(acc.interfaces), (0, _toConsumableArray3.default)(query.interfaces)),
            directives: [].concat((0, _toConsumableArray3.default)(acc.directives), (0, _toConsumableArray3.default)(query.directives)),
            fields: [].concat((0, _toConsumableArray3.default)(acc.fields), (0, _toConsumableArray3.default)(query.fields))
